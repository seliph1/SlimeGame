...
local font_mono = love.graphics.newFont("assets/fonts/NotoSansMono-Regular.ttf", 15)
setFontFallbacks(font_mono, 15)

local font_mono_small = love.graphics.newFont("assets/fonts/NotoSansMono-Regular.ttf", 12)
...
console.input.commands = love.filesystem.load("core/commands.lua")()
...
print( string.format("LÖVE version: %s.%s.%s.%s", love.getVersion() ) )
return console
